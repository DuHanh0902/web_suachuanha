        ...
        <section class="breadcrumb-wrapper mb-5 py-3 py-lg-5">
            <div class="container">
                <nav class="breadcrumb d-flex justify-content-center">
                    <h1 class="breadcrumb-item text-center active">Sản phẩm</h1>
                </nav>
            </div>
        </section>
        <section class="product-grid mb-5">
            <div class="container">
                <div class="row clearfix gy-4">
                <?php foreach($products as $product):?>
                    <div class="col-12 col-md-6 col-lg-4">
                        <a class="product_item d-block position-relative shadow" href="./san-pham/{{$product->product_url_extend}}">
...
<footer id="footer">
    ...
    <script>
        $(".header .navbar-collapse .navbar-nav .nav-item:nth-child(3) .nav-link").addClass("active");
    </script>
